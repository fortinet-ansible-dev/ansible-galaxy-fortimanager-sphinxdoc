...
.. raw:: html
 ...
 <li><span class="li-head">target</span> - Attribute to override for target object. <span class="li-normal">type: dict</span> <span class="li-required">required: true</span></li>
   ...
   <h2 class="handle">
    ...
    <ul class="ul-self">
        ...
        <li><span class="li-normal">params for pm_config_pblock_firewall_policy_sectionvalue:</span></li>
        <ul class="ul-self">
            
            <li><span class="li-normal">required primary key: <b>name</b> </span></li>
            <li><span class="li-normal">optional params list: <a href="docgen/fmgr_pm_config_pblock_firewall_policy_sectionvalue.html#parameters">fmgr_pm_config_pblock_firewall_policy_sectionvalue</a> </span></li>
        </ul>
        ...
        <li><span class="li-normal">params for pm_config_pblock_firewall_securitypolicy_sectionvalue:</span></li>
        <ul class="ul-self">
            
            <li><span class="li-normal">required primary key: <b>name</b> </span></li>
            <li><span class="li-normal">optional params list: <a href="docgen/fmgr_pm_config_pblock_firewall_securitypolicy_sectionvalue.html#parameters">fmgr_pm_config_pblock_firewall_securitypolicy_sectionvalue</a> </span></li>
        </ul>
 ...
 <li><span class="li-head">selector</span> - selector of the renamed object <span class="li-normal">type: str</span> <span class="li-required">choices:</span></li>
    ...
    <ul class="ul-self">
        ...
        <li><span class="li-required">pm_config_pblock_firewall_policy_sectionvalue</span> - available versions:
                    <span class="li-normal">7.2.0</span>
        </li>
        <li><span class="li-required">pm_config_pblock_firewall_securitypolicy</span> - available versions:
                    <span class="li-normal">7.2.0</span>
        </li>
        <li><span class="li-required">pm_config_pblock_firewall_securitypolicy_sectionvalue</span> - available versions:
                    <span class="li-normal">7.2.0</span>
        </li>
