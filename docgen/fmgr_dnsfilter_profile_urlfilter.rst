...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">urlfilter-table</span> - DNS URL filter table ID. <span class="li-normal">type: int</span>  <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
