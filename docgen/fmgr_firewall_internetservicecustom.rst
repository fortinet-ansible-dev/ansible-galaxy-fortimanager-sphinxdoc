...
.. raw:: html
 ...
 <li><span class="li-head">disable-entry</span> - No description for the parameter <span class="li-normal">type: list</span>
 ...
 <ul class="ul-self">
 <li><span class="li-head">end-ip</span> - End IP address. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">start-ip</span> - Start IP address. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">port-range</span> - Port-Range. <span class="li-normal">type: list</span>
 ...
 <ul class="ul-self">
 <li><span class="li-head">end-port</span> - Integer value for ending TCP/UDP/SCTP destination port in range (1 to 65535). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">start-port</span> - Integer value for starting TCP/UDP/SCTP destination port in range (1 to 65535). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">dst6</span> - No description for the parameter <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">master-service-id</span> - Internet Service ID in the Internet Service database. <span class="li-normal">type: str</span>
