...
.. raw:: html
 ...
 <li><span class="li-head">ldap-server</span> - LDAP server to get group information. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">source-ip</span> - Source IP for communications to FSSO agent. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">source-ip6</span> - IPv6 source for communications to FSSO agent. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">ssl-trusted-cert</span> - Trusted server certificate or CA certificate. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">user-info-server</span> - LDAP server to get user information. <span class="li-normal">type: list or str</span>
 ...
 <li><span class="li-head">ldap-poll</span> - Enable/disable automatic fetching of groups from LDAP server. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">ldap-poll-filter</span> - Filter used to fetch groups. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">ldap-poll-interval</span> - Interval in minutes within to fetch groups from LDAP server. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">group-poll-interval</span> - Interval in minutes within to fetch groups from FSSO server, or unset to disable. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">user-info-server</span> - LDAP server to get user information. <span class="li-normal">type: str</span>
