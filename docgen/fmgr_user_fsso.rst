...
.. raw:: html
 ...
 <li><span class="li-head">user_info_server</span> <b>(Alias name: user-info-server)</b>  Ldap server to get user information. <span class="li-normal">type: list or str</span>
