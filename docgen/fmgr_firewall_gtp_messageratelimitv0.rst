...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">create-pdp-request</span> - Rate limit (packets/s) for create PDP context request. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">delete-pdp-request</span> - Rate limit (packets/s) for delete PDP context request. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">echo-request</span> - Rate limit (packets/s) for echo request. <span class="li-normal">type: int</span>
