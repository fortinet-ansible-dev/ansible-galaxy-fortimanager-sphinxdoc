...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">cache-ttl</span> - Minimal TTL of individual IPv6 addresses in FQDN cache. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">end-ip</span> - Final IP address (inclusive) in the range for the address (format: xxxx:xxxx:xxxx:xxxx:xxxx:xxxx:xxxx:xxxx). <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">host-type</span> - Host type. <span class="li-normal">type: str</span> <span class="li-normal">choices: [any, specific]</span> 
 ...
 <li><span class="li-head">start-ip</span> - First IP address (inclusive) in the range for the address (format: xxxx:xxxx:xxxx:xxxx:xxxx:xxxx:xxxx:xxxx). <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">subnet-segment</span> - Subnet-Segment. <span class="li-normal">type: list</span>
