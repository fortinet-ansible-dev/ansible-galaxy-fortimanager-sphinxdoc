...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">domain-name</span> - Fully qualified domain name (FQDN). <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">server-name</span> - Name of the server to connect to. <span class="li-normal">type: str</span>
