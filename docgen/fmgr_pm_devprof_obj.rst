:source: fmgr_pm_devprof_obj.py

:orphan:

.. _fmgr_pm_devprof_obj:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/devprof/adom/{adom}/{pkg_path}</span>  </li>
 </ul>
