...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">cos-queue</span> - Cos-Queue. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">drop-policy</span> - COS queue drop policy. <span class="li-normal">type: str</span> <span class="li-normal">choices: [taildrop, weighted-random-early-detection]</span> 
 ...
 <li><span class="li-head">max-rate</span> - Maximum rate (0 - 4294967295 kbps, 0 to disable). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">min-rate</span> - Minimum rate (0 - 4294967295 kbps, 0 to disable). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">max-rate-percent</span> - Maximum rate (0f link speed). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">min-rate-percent</span> - Minimum rate (0f link speed). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">rate-by</span> - COS queue rate by kbps or percent. <span class="li-normal">type: str</span> <span class="li-normal">choices: [kbps, percent]</span> 
