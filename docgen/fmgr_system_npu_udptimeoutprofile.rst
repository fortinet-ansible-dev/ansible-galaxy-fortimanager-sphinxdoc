...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">id</span> - Timeout profile ID (5-63) <span class="li-normal">type: int</span>  <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
 ...
 <li><span class="li-head">udp-idle</span> - Set UDP idle timeout(seconds) <span class="li-normal">type: int</span>  <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
