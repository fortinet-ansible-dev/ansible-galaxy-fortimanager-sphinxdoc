...
.. raw:: html
 ...
 <li><span class="li-head">port-range</span> - No description for the parameter <span class="li-normal">type: list</span>
 ...
 <ul class="ul-self">
 <li><span class="li-head">end-port</span> - End destination port number (TCP/UDP/SCTP). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">start-port</span> - Start destination port number (TCP/UDP/SCTP). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">master-service-id</span> - Internet service database application ID. <span class="li-normal">type: str</span>
