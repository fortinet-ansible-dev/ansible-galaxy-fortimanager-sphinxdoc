...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [get]</span> - Filters for remote system server.</li>
 <ul class="ul-self">
 <li><span class="li-head">option</span> - Set fetch option for the request. <span class="li-normal">type: str</span>  <span class="li-normal">choices: [object member, chksum, datasrc]</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [set, update]</span> - Filters for remote system server.</li>
 <ul class="ul-self">
...
.. raw:: html
 ...
 <li> <span class="li-return"> severity </span> - Lowest severity level to log. <span class="li-normal">type: str</span>  </li>
 </ul>
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/devprof/{devprof}/log/syslogd/filter</span>  </li>
 </ul>
