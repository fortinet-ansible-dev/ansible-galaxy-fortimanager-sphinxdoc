...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">addr-type</span> - Indicate whether the server IP-address is IPv4 or IPv6. <span class="li-normal">type: str</span> <span class="li-normal">choices: [ipv4, ipv6]</span> 
 ...
 <li><span class="li-head">auth-level</span> - Authentication security level used for the RPC protocol layer. <span class="li-normal">type: str</span> <span class="li-normal">choices: [low, medium, normal, high, connect, call, packet, integrity, privacy]</span> 
 ...
 <li><span class="li-head">auth-type</span> - Authentication security type used for the RPC protocol layer. <span class="li-normal">type: str</span> <span class="li-normal">choices: [spnego, ntlm, kerberos]</span> 
 ...
 <li><span class="li-head">connect-protocol</span> - Connection protocol used to connect to MS Exchange service. <span class="li-normal">type: str</span> <span class="li-normal">choices: [rpc-over-tcp, rpc-over-http, rpc-over-https]</span> 
 ...
 <li><span class="li-head">domain-name</span> - MS Exchange server fully qualified domain name. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">http-auth-type</span> - Authentication security type used for the HTTP transport. <span class="li-normal">type: str</span> <span class="li-normal">choices: [ntlm, basic]</span> 
 ...
 <li><span class="li-head">kdc-ip</span> - KDC IPv4 addresses for Kerberos authentication. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">server-name</span> - MS Exchange server hostname. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">ssl-min-proto-version</span> - Minimum SSL/TLS protocol version for HTTPS transport (default is to follow system global setting). <span class="li-normal">type: str</span> <span class="li-normal">choices: [default, TLSv1-1, TLSv1-2, SSLv3, TLSv1, TLSv1-3]</span> 
 ...
 <li><span class="li-head">auto-discover-kdc</span> - Enable/disable automatic discovery of KDC IP addresses. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
