...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">log-interval-dev-no-logging</span> - Interval in minute for logging the event of no logs received from a device. <span class="li-normal">type: int</span> <span class="li-normal">default: 1440</span> 
 ...
 <li><span class="li-head">log-interval-disk-full</span> - Interval in minute for logging the event of disk full. <span class="li-normal">type: int</span> <span class="li-normal">default: 5</span> 
 ...
 <li><span class="li-head">log-interval-gbday-exceeded</span> - Interval in minute for logging the event of the GB/Day license exceeded. <span class="li-normal">type: int</span> <span class="li-normal">default: 1440</span> 
 ...
 <li><span class="li-head">log-daemon-crash</span> - Send a logmsg when a daemon crashes. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span>  <span class="li-normal">default: disable</span> 
 ...
 <li><span class="li-head">no-log-detection-threshold</span> - Time interval in minutes to trigger a local event message if no log data is received. <span class="li-normal">type: int</span> <span class="li-normal">default: 15</span> 
 ...
 <li><span class="li-head">log-interval-adom-perf-stats</span> - Interval in minute for logging the event of adom perf stats. <span class="li-normal">type: int</span> <span class="li-normal">default: 60</span> 
