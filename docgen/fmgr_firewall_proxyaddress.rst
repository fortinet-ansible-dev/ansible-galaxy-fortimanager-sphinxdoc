...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">case-sensitivity</span> - Enable to make the pattern case sensitive. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">header-name</span> - Name of HTTP header. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">host-regex</span> - Host name as a regular expression. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">ua-max-ver</span> - Maximum version of the user agent specified in dotted notation. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">ua-min-ver</span> - Minimum version of the user agent specified in dotted notation. <span class="li-normal">type: str</span>
