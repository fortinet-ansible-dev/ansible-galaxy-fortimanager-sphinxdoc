...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">create-session-request</span> - Rate limit (packets/s) for create session request. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">delete-session-request</span> - Rate limit (packets/s) for delete session request. <span class="li-normal">type: int</span>
