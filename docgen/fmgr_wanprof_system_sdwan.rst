...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">duplication</span> - No description for the parameter <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">packet-de-duplication</span> - Enable/disable discarding of packets that have been duplicated. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">packet-duplication</span> - Configure packet duplication method. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, force, on-demand]</span> 
 ...
 <li><span class="li-head">service-id</span> - SD-WAN service rule ID list. <span class="li-normal">type: list or str</span>
 ...
 <li><span class="li-head">sla-match-service</span> - Enable/disable packet duplication matching health-check SLAs in service rule. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">duplication-max-num</span> - Maximum number of interface members a packet is duplicated in the SD-WAN zone (2 - 4, default = 2; if set to 3, the original packet plus 2 more copies are created). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">fail-detect</span> - Enable/disable SD-WAN Internet connection status checking (failure detection). <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">health-check</span> - No description for the parameter <span class="li-normal">type: list</span>
 ...
 <ul class="ul-self">
 <li><span class="li-head">_dynamic-server</span> - No description for the parameter <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">addr-mode</span> - Address mode (IPv4 or IPv6). <span class="li-normal">type: str</span> <span class="li-normal">choices: [ipv4, ipv6]</span> 
 ...
 <li><span class="li-head">dns-match-ip</span> - Response IP expected from DNS server if the protocol is DNS. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">dns-request-domain</span> - Fully qualified domain name to resolve for the DNS probe. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">ftp-file</span> - Full path and file name on the FTP server to download for FTP health-check to probe. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">ftp-mode</span> - FTP mode. <span class="li-normal">type: str</span> <span class="li-normal">choices: [passive, port]</span> 
 ...
 <li><span class="li-head">ha-priority</span> - HA election priority (1 - 50). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">http-agent</span> - String in the http-agent field in the HTTP header. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">http-get</span> - URL used to communicate with the server if the protocol if the protocol is HTTP. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">http-match</span> - Response string expected from the server if the protocol is HTTP. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">packet-size</span> - Packet size of a twamp test session, <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">password</span> - No description for the parameter <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">probe-count</span> - Number of most recent probes that should be used to calculate latency and jitter (5 - 30, default = 30). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">probe-packets</span> - Enable/disable transmission of probe packets. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">probe-timeout</span> - Time to wait before a probe packet is considered lost (500 - 3600*1000 msec, default = 500). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">quality-measured-method</span> - Method to measure the quality of tcp-connect. <span class="li-normal">type: str</span> <span class="li-normal">choices: [half-close, half-open]</span> 
 ...
 <li><span class="li-head">security-mode</span> - Twamp controller security mode. <span class="li-normal">type: str</span> <span class="li-normal">choices: [none, authentication]</span> 
 ...
 <li><span class="li-head">server</span> - No description for the parameter <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">sla</span> - No description for the parameter <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">jitter-threshold</span> - Jitter for SLA to make decision in milliseconds. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">latency-threshold</span> - Latency for SLA to make decision in milliseconds. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">link-cost-factor</span> - No description for the parameter <span class="li-normal">type: list</span> <span class="li-normal">choices: [latency, jitter, packet-loss, mos]</span> 
 ...
 <li><span class="li-head">packetloss-threshold</span> - Packet loss for SLA to make decision in percentage. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">mos-threshold</span> - Minimum Mean Opinion Score for SLA to be marked as pass. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">priority-in-sla</span> - Value to be distributed into routing table when in-sla (0 - 65535, default = 0). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">priority-out-sla</span> - Value to be distributed into routing table when out-sla (0 - 65535, default = 0). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">sla-fail-log-period</span> - Time interval in seconds that SLA fail log messages will be generated (0 - 3600, default = 0). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">sla-pass-log-period</span> - Time interval in seconds that SLA pass log messages will be generated (0 - 3600, default = 0). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">system-dns</span> - Enable/disable system DNS as the probe server. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">threshold-alert-jitter</span> - Alert threshold for jitter (ms, default = 0). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">threshold-alert-latency</span> - Alert threshold for latency (ms, default = 0). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">threshold-alert-packetloss</span> - Alert threshold for packet loss (percentage, default = 0). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">threshold-warning-jitter</span> - Warning threshold for jitter (ms, default = 0). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">threshold-warning-latency</span> - Warning threshold for latency (ms, default = 0). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">threshold-warning-packetloss</span> - Warning threshold for packet loss (percentage, default = 0). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">update-cascade-interface</span> - Enable/disable update cascade interface. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">update-static-route</span> - Enable/disable updating the static route. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">detect-mode</span> - The mode determining how to detect the server. <span class="li-normal">type: str</span> <span class="li-normal">choices: [active, passive, prefer-passive, remote, agent-based]</span> 
 ...
 <li><span class="li-head">mos-codec</span> - Codec to use for MOS calculation (default = g711). <span class="li-normal">type: str</span> <span class="li-normal">choices: [g711, g722, g729]</span> 
 ...
 <li><span class="li-head">embed-measured-health</span> - Enable/disable embedding measured health information. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">sla-id-redistribute</span> - Select the ID from the SLA sub-table. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">class-id</span> - Traffic class ID. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">load-balance-mode</span> - Algorithm or mode to use for load balancing Internet traffic to SD-WAN members. <span class="li-normal">type: str</span> <span class="li-normal">choices: [source-ip-based, weight-based, usage-based, source-dest-ip-based, measured-volume-based]</span> 
 ...
 <li><span class="li-head">members</span> - No description for the parameter <span class="li-normal">type: list</span>
 ...
 <ul class="ul-self">
 <li><span class="li-head">_dynamic-member</span> - No description for the parameter <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">ingress-spillover-threshold</span> - Ingress spillover threshold for this interface (0 - 16776000 kbit/s). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">seq-num</span> - Sequence number(1-512). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">spillover-threshold</span> - Egress spillover threshold for this interface (0 - 16776000 kbit/s). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">volume-ratio</span> - Measured volume ratio (this value / sum of all values = percentage of link volume, 1 - 255). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">preferred-source</span> - Preferred source of route for this member. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">neighbor</span> - No description for the parameter <span class="li-normal">type: list</span>
 ...
 <ul class="ul-self">
 <li><span class="li-head">health-check</span> - SD-WAN health-check name. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">sla-id</span> - SLA ID. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">minimum-sla-meet-members</span> - Minimum number of members which meet SLA when the neighbor is preferred. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">service-id</span> - SD-WAN service ID to work with the neighbor. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">neighbor-hold-boot-time</span> - Waiting period in seconds when switching from the primary neighbor to the secondary neighbor from the neighbor start. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">neighbor-hold-down</span> - Enable/disable hold switching from the secondary neighbor to the primary neighbor. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">neighbor-hold-down-time</span> - Waiting period in seconds when switching from the secondary neighbor to the primary neighbor when hold-down is disabled. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">bandwidth-weight</span> - Coefficient of reciprocal of available bidirectional bandwidth in the formula of custom-profile-1. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">dscp-forward</span> - Enable/disable forward traffic DSCP tag. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">dscp-forward-tag</span> - Forward traffic DSCP tag. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">dscp-reverse</span> - Enable/disable reverse traffic DSCP tag. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">dscp-reverse-tag</span> - Reverse traffic DSCP tag. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">dst-negate</span> - Enable/disable negation of destination address match. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">end-port</span> - End destination port number. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">hash-mode</span> - Hash algorithm for selected priority members for load balance mode. <span class="li-normal">type: str</span> <span class="li-normal">choices: [round-robin, source-ip-based, source-dest-ip-based, inbandwidth, outbandwidth, bibandwidth]</span> 
 ...
 <li><span class="li-head">health-check</span> - Health check list. <span class="li-normal">type: list or str</span>
 ...
 <li><span class="li-head">hold-down-time</span> - Waiting period in seconds when switching from the back-up member to the primary member (0 - 10000000, default = 0). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">input-device</span> - Source interface name. <span class="li-normal">type: list or str</span>
 ...
 <li><span class="li-head">input-device-negate</span> - Enable/disable negation of input device match. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">internet-service</span> - Enable/disable use of Internet service for application-based load balancing. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">internet-service-app-ctrl</span> - No description for the parameter <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">internet-service-app-ctrl-group</span> - Application control based Internet Service group list. <span class="li-normal">type: list or str</span>
 ...
 <li><span class="li-head">internet-service-custom</span> - Custom Internet service name list. <span class="li-normal">type: list or str</span>
 ...
 <li><span class="li-head">internet-service-custom-group</span> - Custom Internet Service group list. <span class="li-normal">type: list or str</span>
 ...
 <li><span class="li-head">internet-service-group</span> - Internet Service group list. <span class="li-normal">type: list or str</span>
 ...
 <li><span class="li-head">internet-service-name</span> - Internet service name list. <span class="li-normal">type: list or str</span>
 ...
 <li><span class="li-head">jitter-weight</span> - Coefficient of jitter in the formula of custom-profile-1. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">latency-weight</span> - Coefficient of latency in the formula of custom-profile-1. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">link-cost-factor</span> - Link cost factor. <span class="li-normal">type: str</span> <span class="li-normal">choices: [latency, jitter, packet-loss, inbandwidth, outbandwidth, bibandwidth, custom-profile-1]</span> 
 ...
 <li><span class="li-head">link-cost-threshold</span> - Percentage threshold change of link cost values that will result in policy route regeneration (0 - 10000000, default = 10). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">minimum-sla-meet-members</span> - Minimum number of members which meet SLA. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">packet-loss-weight</span> - Coefficient of packet-loss in the formula of custom-profile-1. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">priority-members</span> - Member sequence number list. <span class="li-normal">type: list or str</span>
 ...
 <li><span class="li-head">quality-link</span> - Quality grade. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">route-tag</span> - IPv4 route map route-tag. <span class="li-normal">type: int</span>
 ...
 <ul class="ul-self">
 <li><span class="li-head">health-check</span> - SD-WAN health-check. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">sla-compare-method</span> - Method to compare SLA value for SLA mode. <span class="li-normal">type: str</span> <span class="li-normal">choices: [order, number]</span> 
 ...
 <li><span class="li-head">src-negate</span> - Enable/disable negation of source address match. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">standalone-action</span> - Enable/disable service when selected neighbor role is standalone while service role is not standalone. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">start-port</span> - Start destination port number. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">tos-mask</span> - Type of service evaluated bits. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">tie-break</span> - Method of selecting member if more than one meets the SLA. <span class="li-normal">type: str</span> <span class="li-normal">choices: [zone, cfg-order, fib-best-match, input-device]</span> 
 ...
 <li><span class="li-head">use-shortcut-sla</span> - Enable/disable use of ADVPN shortcut for quality comparison. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">input-zone</span> - No description for the parameter <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">internet-service-app-ctrl-category</span> - No description for the parameter <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">passive-measurement</span> - Enable/disable passive measurement based on the service criteria. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">priority-zone</span> - No description for the parameter <span class="li-normal">type: list or str</span>
 ...
 <li><span class="li-head">agent-exclusive</span> - Set/unset the service as agent use exclusively. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">shortcut-stickiness</span> - Enable/disable shortcut-stickiness of ADVPN. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">end-src-port</span> - End source port number. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">load-balance</span> - Enable/disable load-balance. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">sla-stickiness</span> - Enable/disable SLA stickiness (default = disable). <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">start-src-port</span> - Start source port number. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">zone-mode</span> - Enable/disable zone mode. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">zone</span> - No description for the parameter <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">service-sla-tie-break</span> - Method of selecting member if more than one meets the SLA. <span class="li-normal">type: str</span> <span class="li-normal">choices: [cfg-order, fib-best-match, input-device]</span> 
 ...
 <li><span class="li-head">speedtest-bypass-routing</span> - Enable/disable bypass routing when speedtest on a SD-WAN member. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">fail-alert-interfaces</span> - No description for the parameter <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">app-perf-log-period</span> - Time interval in seconds that applicationperformance logs are generated (0 - 3600, default = 0). <span class="li-normal">type: int</span>
