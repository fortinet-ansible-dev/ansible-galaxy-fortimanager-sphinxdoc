...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">class-id</span> - Class ID to be named. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">class-name</span> - Define the name for this class-id. <span class="li-normal">type: str</span>
