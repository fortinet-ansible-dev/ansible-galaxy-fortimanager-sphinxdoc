...
.. raw:: html
 ...
 <li><span class="li-head">dhcp-ip-addr</span> - IP address of the monitoring DHCP request packet sent through the tunnel. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">ping-interval</span> - Interval between two tunnel monitoring echo packets (1 - 65535 sec, default = 1). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">ping-number</span> - Number of the tunnel monitoring echo packets (1 - 65535, default = 5). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">return-packet-timeout</span> - Window of time for the return packets from the tunnels remote end (1 - 65535 sec, default = 160). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">tunnel-type</span> - Tunnel type. <span class="li-normal">type: str</span> <span class="li-normal">choices: [gre, l2tpv3]</span> 
 ...
 <li><span class="li-head">wag-ip</span> - IP Address of the wireless access gateway. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">wag-port</span> - UDP port of the wireless access gateway. <span class="li-normal">type: int</span>
