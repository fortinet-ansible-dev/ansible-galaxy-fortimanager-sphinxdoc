...
.. raw:: html
 ...
 <li><span class="li-head">max-connections</span> - Maximum number of web proxy WISP connections (4 - 4096, default = 64). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">outgoing-ip</span> - WISP outgoing IP address. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">server-ip</span> - WISP server IP address. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">server-port</span> - WISP server port (1 - 65535, default = 15868). <span class="li-normal">type: int</span>
