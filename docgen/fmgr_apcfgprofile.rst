...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">ac-ip</span> - IP address of the validation controller that AP must be able to join after applying AP local configuration. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">ac-port</span> - Port of the validation controller that AP must be able to join after applying AP local configuration (1024 - 49150, default = 5246). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">ac-timer</span> - Maximum waiting time for the AP to join the validation controller after applying AP local configuration (3 - 30 min, default = 10). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">ac-type</span> - Validation controller type (default = default). <span class="li-normal">type: str</span> <span class="li-normal">choices: [default, specify, apcfg]</span> 
 ...
 <li><span class="li-head">command-list</span> - Command-List. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">passwd-value</span> - AP local configuration command password value. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">ap-family</span> - FortiAP family type (default = fap). <span class="li-normal">type: str</span> <span class="li-normal">choices: [fap, fap-u, fap-c]</span> 
