...
.. raw:: html
 ...
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.0.1 -> v7.2.0</code></p>
 </div>
 </li>
 ...
 <li><span class="li-head">object_position</span> <b>(Alias name: object position)</b>  <span class="li-normal">type: list</span> </li>
 </ul>
 </ul>
