...
.. raw:: html
 ...
 <li><span class="li-head">dp_log_dyn_flags</span> <b>(Alias name: dp-log-dyn_flags)</b>  Dp-log-dyn_flags. <span class="li-normal">type: list</span> <span class="li-normal">choices: [none, protocol-error, profile-missing, context-missing, accounting-stop-missed, accounting-event, radiusd-other, endpoint-block]</span> 
