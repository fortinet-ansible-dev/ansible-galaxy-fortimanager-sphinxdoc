...
.. raw:: html
 ...
 <li><span class="li-head">look-ahead</span> - Number of characters to obtain in advance for verification (1 - 255, default = 1). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">look-back</span> - Number of characters required to save for verification (1 - 255, default = 1). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">verify-transformed-pattern</span> - Enable/disable verification for transformed pattern. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">match-around</span> - Dictionary to check whether it has a match around (Only support match-any and basic types, no repeat supported). <span class="li-normal">type: str</span>
