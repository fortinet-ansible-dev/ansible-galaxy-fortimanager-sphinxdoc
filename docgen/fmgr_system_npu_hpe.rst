...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">all-protocol</span> - Maximum packet rate of each host queue except high priority traffic(1K - 32M pps, default = 400K pps), set 0 to disable. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">arp-max</span> - Maximum ARP packet rate (1K - 32M pps, default = 5K pps). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">enable-shaper</span> - Enable/Disable NPU Host Protection Engine (HPE) for packet type shaper. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">esp-max</span> - Maximum ESP packet rate (1K - 32M pps, default = 5K pps). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">high-priority</span> - Maximum packet rate for high priority traffic packets (1K - 32M pps, default = 400K pps). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">icmp-max</span> - Maximum ICMP packet rate (1K - 32M pps, default = 5K pps). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">ip-frag-max</span> - Maximum fragmented IP packet rate (1K - 32M pps, default = 5K pps). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">ip-others-max</span> - Maximum IP packet rate for other packets (packet types that cannot be set with other options) (1K - 32G pps, default = 5K pps). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">l2-others-max</span> - Maximum L2 packet rate for L2 packets that are not ARP packets (1K - 32M pps, default = 5K pps). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">pri-type-max</span> - Maximum overflow rate of priority type traffic(1K - 32M pps, default = 40K pps). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">sctp-max</span> - Maximum SCTP packet rate (1K - 32M pps, default = 5K pps). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">tcp-max</span> - Maximum TCP packet rate (1K - 32M pps, default = 40K pps). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">tcpfin-rst-max</span> - Maximum TCP carries FIN or RST flags packet rate (1K - 32M pps, default = 40K pps). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">tcpsyn-ack-max</span> - Maximum TCP carries SYN and ACK flags packet rate (1K - 32M pps, default = 40K pps). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">tcpsyn-max</span> - Maximum TCP SYN packet rate (1K - 40M pps, default = 32K pps). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">udp-max</span> - Maximum UDP packet rate (1K - 32M pps, default = 40K pps). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">enable-queue-shaper</span> - Enable/Disable NPU host protection engine (HPE) queue shaper. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">exception-code</span> - Maximum exception code rate of traffic(1K - 32M pps, default = 1M pps). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">fragment-with-sess</span> - Maximum fragment with session rate of traffic(1K - 32M pps, default = 1M pps). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">fragment-without-session</span> - Maximum fragment without session rate of traffic(1K - 32M pps, default = 1M pps). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">queue-shaper-max</span> - Maximum per queue byte rate of traffic(1K - 32M pps, default = 1M pps). <span class="li-normal">type: int</span>
