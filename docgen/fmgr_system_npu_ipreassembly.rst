...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">max-timeout</span> - Maximum timeout value for IP reassembly (5 us - 600,000,000 us). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">min-timeout</span> - Minimum timeout value for IP reassembly (5 us - 600,000,000 us). <span class="li-normal">type: int</span>
