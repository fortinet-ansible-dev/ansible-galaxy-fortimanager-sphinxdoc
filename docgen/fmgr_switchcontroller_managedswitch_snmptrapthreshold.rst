...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">trap-high-cpu-threshold</span> - CPU usage when trap is sent. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">trap-log-full-threshold</span> - Log disk usage when trap is sent. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">trap-low-memory-threshold</span> - Memory usage when trap is sent. <span class="li-normal">type: int</span>
