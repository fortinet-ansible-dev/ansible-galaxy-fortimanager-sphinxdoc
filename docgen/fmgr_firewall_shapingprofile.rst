...
.. raw:: html
 ...
 <li><span class="li-head">default-class-id</span> - Default class ID to handle unclassified packets (including all local traffic). <span class="li-normal">type: int or str</span>
 ...
 <li><span class="li-head">profile-name</span> - Shaping profile name. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">shaping-entries</span> - Shaping-Entries. <span class="li-normal">type: list</span>
 ...
 <ul class="ul-self">
 <li><span class="li-head">class-id</span> - Class ID. <span class="li-normal">type: int or str</span>
 ...
 <li><span class="li-head">guaranteed-bandwidth-percentage</span> - Guaranteed bandwith in percentage. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">maximum-bandwidth-percentage</span> - Maximum bandwith in percentage. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">burst-in-msec</span> - Number of bytes that can be burst at maximum-bandwidth speed. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">cburst-in-msec</span> - Number of bytes that can be burst as fast as the interface can transmit. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">red-probability</span> - Maximum probability (in percentage) for RED marking. <span class="li-normal">type: int</span>
