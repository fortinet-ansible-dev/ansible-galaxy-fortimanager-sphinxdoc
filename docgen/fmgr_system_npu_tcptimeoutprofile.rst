...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">close-wait</span> - Set close-wait timeout(seconds) <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">fin-wait</span> - Set fin-wait timeout(seconds) <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">syn-sent</span> - Set syn-sent timeout(seconds) <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">syn-wait</span> - Set syn-wait timeout(seconds) <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">tcp-idle</span> - Set TCP establish timeout(seconds) <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">time-wait</span> - Set time-wait timeout(seconds) <span class="li-normal">type: int</span>
