...
.. raw:: html
 ...
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.0.3 -> v7.6.7</code></p>
 </div>
 </li>
 ...
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.0.3 -> v7.2.1</code>, <code class="docutils literal notranslate">v7.4.8 -> v7.4.11</code></p>
 </div>
 </li>
