...
.. raw:: html
 ...
 <li><span class="li-head">severity-level</span> - Alert console keeps alerts of this and higher severity. <span class="li-normal">type: list</span> <span class="li-normal">choices: [debug, information, notify, warning, error, critical, alert, emergency]</span> 
