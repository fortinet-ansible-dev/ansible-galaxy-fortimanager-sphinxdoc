...
.. raw:: html
 ...
 <li><span class="li-head">mac-filter-policy</span> - Deny or allow the client with this MAC address. <span class="li-normal">type: str</span> <span class="li-normal">choices: [deny, allow]</span> 
