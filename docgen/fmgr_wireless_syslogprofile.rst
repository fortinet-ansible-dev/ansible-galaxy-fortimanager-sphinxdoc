...
.. raw:: html
 ...
 <li><span class="li-head">log-level</span> - Lowest level of log messages that FortiAP units send to this server (default = information). <span class="li-normal">type: str</span> <span class="li-normal">choices: [emergency, alert, critical, error, warning, notification, information, debugging]</span> 
 ...
 <li><span class="li-head">server-addr-type</span> - Syslog server address type (default = ip). <span class="li-normal">type: str</span> <span class="li-normal">choices: [fqdn, ip]</span> 
 ...
 <li><span class="li-head">server-fqdn</span> - FQDN of syslog server that FortiAP units send log messages to. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">server-ip</span> - IP address of syslog server that FortiAP units send log messages to. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">server-port</span> - Port number of syslog server that FortiAP units send log messages to (default = 514). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">server-status</span> - Enable/disable FortiAP units to send log messages to a syslog server (default = enable). <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
