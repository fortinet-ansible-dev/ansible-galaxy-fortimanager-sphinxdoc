...
.. raw:: html
 ...
 <li><span class="li-head">ssh-policy-check</span> - Enable/disable SSH policy check. <span class="li-normal">type: str</span>  <span class="li-normal">choices: [disable, enable]</span> </li>
