...
.. raw:: html
 ...
 <tr>
 <td>pm_config_pblock_firewall_securitypolicy_sectionvalue</td>
 <td>yes</td>
 </tr>
 </table>
 <p>
...
.. raw:: html
 ...
 <li><span class="li-head">pm_config_pblock_firewall_securitypolicy_sectionvalue</span> - no description <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">attr</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [label, global-label]</span>  <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
