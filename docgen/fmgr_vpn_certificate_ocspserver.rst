...
.. raw:: html
 ...
 <li><span class="li-head">secondary-cert</span> - Secondary OCSP server certificate. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">secondary-url</span> - Secondary OCSP server URL. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">source-ip</span> - Source IP address for communications to the OCSP server. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">unavail-action</span> - Action when server is unavailable (revoke the certificate or ignore the result of the check). <span class="li-normal">type: str</span> <span class="li-normal">choices: [revoke, ignore]</span> 
