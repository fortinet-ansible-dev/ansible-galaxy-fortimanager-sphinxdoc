...
.. raw:: html
 ...
 <li><span class="li-head">inactive-timer</span> - Time interval(minutes) to be included in the inactive devices expiry calculation (mac age-out + inactive-time + periodic scan interval). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">link-down-flush</span> - Clear NAC and dynamic devices on switch ports on link down event. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">nac-ports</span> <span class="li-normal">type: dict</span> <ul class="ul-self">
 <li><span class="li-head">lan-segment</span> - Enable/disable LAN segment feature on the FortiLink interface. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disabled, enabled]</span> 
 ...
 <li><span class="li-head">member-change</span> - No description for the parameter <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">nac-lan-interface</span> - Configure NAC LAN interface. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">nac-segment-vlans</span> - No description for the parameter <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">onboarding-vlan</span> - Default NAC Onboarding VLAN when NAC devices are discovered. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">parent-key</span> - No description for the parameter <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">bounce-nac-port</span> - Enable/disable bouncing (administratively bring the link down, up) of a switch port when NAC mode is configured on the port. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">access-vlan-mode</span> - Intra VLAN traffic behavior with loss of connection to the FortiGate. <span class="li-normal">type: str</span> <span class="li-normal">choices: [legacy, fail-open, fail-close]</span> 
