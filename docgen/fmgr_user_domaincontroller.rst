...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">domain-name</span> - Domain DNS name. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">extra-server</span> - Extra-Server. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">ip-address</span> - Domain controller IP address. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">source-ip-address</span> - FortiGate IPv4 address to be used for communication with the domain controller. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">source-port</span> - Source port to be used for communication with the domain controller. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">ldap-server</span> - LDAP server name. <span class="li-normal">type: list or str</span>
 ...
 <li><span class="li-head">ad-mode</span> - Set Active Directory mode. <span class="li-normal">type: str</span> <span class="li-normal">choices: [none, ds, lds]</span> 
 ...
 <li><span class="li-head">adlds-dn</span> - AD LDS distinguished name. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">adlds-ip-address</span> - AD LDS IPv4 address. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">adlds-ip6</span> - AD LDS IPv6 address. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">adlds-port</span> - Port number of AD LDS service (default = 389). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">dns-srv-lookup</span> - Enable/disable DNS service lookup. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">replication-port</span> - Port to be used for communication with the domain controller for replication service. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">source-ip6</span> - FortiGate IPv6 address to be used for communication with the domain controller. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">change-detection</span> - Enable/disable detection of a configuration change in the Active Directory server. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">change-detection-period</span> - Minutes to detect a configuration change in the Active Directory server (5 - 10080 minutes (7 days), default = 60). <span class="li-normal">type: int</span>
